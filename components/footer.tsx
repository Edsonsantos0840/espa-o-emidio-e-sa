      ...
      <div className={style.container}>
        <div className={style.sepFooter}>
          ...
          <div className={style.ico}>
            <Link href={'https://www.facebook.com/profile.php?id=100095584324495&mibextid=LQQJ4d'} target='blank'>
              <span><BsFacebook /></span>
            </Link>
            <Link href={'https://www.instagram.com/espaco_emidiosa.sx/'} target='blank'> 
      ...
      <div className={style.container}>
        <div className={style.separa}>
          ...
          <div className={style.icone}>
            <Link href={'https://goo.gl/maps/ZGWVF4kh82wWjVMX9'} target='blank'>
        ...
        <div className={style.separa}>
          <h1>Telefone:</h1>
          <div className={style.icone}>
            <Link href={'https://wa.me/5519991062455?text=Ol%C3%A1+visitei+seu+site%2C+quero+um+or%C3%A7amento.'} target='blank'><span>
