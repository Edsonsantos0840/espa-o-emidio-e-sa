        ...
        <div className={style.divide}>
          <div className={style.informações} onMouseOver={() => setMostra1(true)} onMouseOut={() => setMostra1(false)}>
            ...
            <ul className={mostra1 ? style.exibe : style.esconde} >
              <h4>
                <strong>Existem diversas abordagens e técnicas dentro da massoterapia, cada uma com suas  características e objetivos específicos. Algumas das técnicas mais comuns incluem :</strong>
              </h4>
              <p>
                <span>Massagem Clássica ou Sueca:</span> Uma das formas mais conhecidas de massoterapia, que utiliza movimentos como amassamento, deslizamento, fricção e percussão para relaxar os músculos e melhorar a circulação.
              </p>
              <p>
                <span>Massagem Terapêutica:</span > Concentra-se em áreas específicas do corpo para tratar dores musculares, lesões e disfunções físicas. Pode envolver técnicas como liberação miofascial, alongamento e pressão profunda.
              </p>
              <p>
                <span>Massagem Desportiva: </span> Projetada para atletas e pessoas envolvidas em atividades físicas intensas. Ajuda na prevenção e recuperação de lesões, melhorando o desempenho atlético.
              </p>
              <p>
                <span>Massagem Shiatsu:</span> Originária do Japão, utiliza pressão dos dedos em pontos específicos do corpo para equilibrar o fluxo de energia (conhecido como qi ou chi).
              </p>
              <p>
                <span>Massagem Tailandesa:</span> Realizada no chão, com o paciente vestido com roupas confortáveis. Envolve alongamentos passivos e pressões ao longo das linhas de energia do corpo.
              </p>
              <p>
                <span>Massagem de Pedras Quentes: </span> Utiliza pedras aquecidas para massagear o corpo, combinando o calor terapêutico com a pressão das pedras.
              </p>
              <p>
                <span>Massagem Reflexológica:</span> Baseia-se na ideia de que diferentes partes dos pés, mãos e orelhas estão conectadas a órgãos e sistemas do corpo. Estimular essas áreas pode promover o equilíbrio e a cura.
              </p>
              <p>
                <span>Massagem Ayurvédica</span> Originada da Índia, combina técnicas de massagem com os princípios da medicina ayurvédica, visando equilibrar os doshas (energias) do corpo.
              </p><br />
              <h4>
